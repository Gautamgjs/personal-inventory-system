	...
	<div id="content-wrap">
		...
		<div id="main">
			...
			<div class="box">
				...
				<form action="incomedb.php" method="GET">
                <p>
				  <table>
					<tr><td></td>
					<th>Income :</th><td> <input type="text" name="income" ></td>
				  ...
				  <tr><td></td>
					...
					{
					?>
					<option value="<?php echo $row['inc_catid'];?>">
					<?php echo $row['inc_catname'];?></option>
					<?php
					}
					}
					?>
				...
				<tr><th></th>
				<td><input type="submit" name="add_inc" value="ADD INCOME">
